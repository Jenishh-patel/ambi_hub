"""
Django settings for ambitioushub project.
"""
import os
...
ROOT_URLCONF = 'ambitioushub.urls'
...
WSGI_APPLICATION = 'ambitioushub.wsgi.application'
...
# Password reset (for email links)
if DEBUG:
    # In development, use console backend (emails print to console)
    # For production, configure SMTP settings above
    pass
